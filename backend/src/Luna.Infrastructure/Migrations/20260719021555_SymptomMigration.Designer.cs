...
namespace Luna.Infrastructure.Migrations
{
    ...
    [Migration("20260719021555_SymptomMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Luna.Domain.Entities.HealthProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Luna.Domain.Entities.PeriodEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Luna.Domain.Entities.Pregnancy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Luna.Domain.Entities.SymptomEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Luna.Domain.Entities.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Luna.Domain.Entities.HealthProfile", b =>
                {
                    b.HasOne("Luna.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("Luna.Domain.Entities.HealthProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Luna.Domain.Entities.UserProfile", b =>
                {
                    b.HasOne("Luna.Domain.Entities.User", "User")
                        .WithOne("Profile")
                        .HasForeignKey("Luna.Domain.Entities.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

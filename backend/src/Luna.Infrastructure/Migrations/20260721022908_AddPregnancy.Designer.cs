...
namespace Luna.Infrastructure.Migrations
{
    ...
    [Migration("20260721022908_AddPregnancy")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Luna.Domain.Entities.Auth.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Luna.Domain.Entities.Auth.Session", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Luna.Domain.Entities.Auth.Verification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Luna.Domain.Entities.Cycle.PeriodEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("PeriodEntries", (string)null);
                });

            modelBuilder.Entity("Luna.Domain.Entities.Cycle.SymptomEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("SymptomEntries", (string)null);
                });

            modelBuilder.Entity("Luna.Domain.Entities.Pregnancies.Pregnancy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool?>("IsFirstPregnancy")
                        .HasColumnType("boolean")
                        .HasColumnName("is_first_pregnancy");
            ...
            modelBuilder.Entity("Luna.Domain.Entities.Users.HealthProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Luna.Domain.Entities.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Luna.Domain.Entities.Users.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Luna.Domain.Entities.Auth.Account", b =>
                {
                    b.HasOne("Luna.Domain.Entities.Users.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Luna.Domain.Entities.Users.HealthProfile", b =>
                {
                    b.HasOne("Luna.Domain.Entities.Users.User", "User")
                        ...
                        .HasForeignKey("Luna.Domain.Entities.Users.HealthProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Luna.Domain.Entities.Users.UserProfile", b =>
                {
                    b.HasOne("Luna.Domain.Entities.Users.User", "User")
                        .WithOne("Profile")
                        .HasForeignKey("Luna.Domain.Entities.Users.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
